...
if ($result->num_rows > 0) {
  ...
  while($row = $result->fetch_assoc()) {
    ...
    echo "<a href=http://localhost/latihan1/hapus.php?id=".$row["id"].">hapus</a></td><td><a href=http://localhost/latihan1/edit.php?firstname=".$row["firstname"]."&lastname=".$row["lastname"]."&email=".$row["email"]."&id=".$row["id"].">update</td></tr>";
  }
} else {
  echo "0 results";
}
